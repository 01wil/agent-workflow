...
An acceptance criterion has to be falsifiable by running something. "The duplicate rows are gone"
is not a criterion. "`SELECT COUNT(*) FROM contracts WHERE ...` returns 14322, down from 14452,
and the daily job still produces a report with an unchanged row count for the prior day" is.
