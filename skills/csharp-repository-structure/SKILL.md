...
- Update `.gitignore` using the repository's existing style. Ensure it covers `notes/`, `bin/`, `obj/`, `.vs/`, `*.user`, and `TestResults/` without discarding useful existing rules.
